...
.slide-btn:disabled { opacity: 0.5; cursor: not-allowed; pointer-events: none; }
...
.slide-btn--dark::before { background-color: #383838; }

.slide-btn--primary {
  background-color: #1ec8a0;
  color: #04120e;
  border: 2px solid #1ec8a0;
}
.slide-btn--primary::before { background-color: #14ad89; }
...
.slide-btn--outline::before { background-color: rgba(0,0,0,0.06); }

.slide-btn--outline-inv {
  background-color: rgba(10, 24, 20, 0.55);
  color: #d9fff3;
  border: 2px solid rgba(30, 200, 160, 0.45);
}
    ...
    return (
        <section ref={containerRef} className="relative pt-[80px] pb-[40px] flex flex-col items-center overflow-hidden pointer-events-none">
            ...
            <div className="absolute left-0 top-[15%] hidden lg:block hero-anim transition-all duration-500 hover:scale-105 z-0 pointer-events-auto">
                <div className="hero-svg-wrapper left-graphic w-[220px] xl:w-[320px] drop-shadow-2xl">
                    <img src="/assets/landing-page/hero-left.svg" alt="" aria-hidden className="w-full h-auto" />
                </div>
            </div>
            <div className="absolute right-0 top-[10%] hidden lg:block hero-anim transition-all duration-500 hover:scale-105 z-0 pointer-events-auto">
                <div className="hero-svg-wrapper right-graphic w-[220px] xl:w-[320px] drop-shadow-2xl">
                    <img src="/assets/landing-page/hero-right.svg" alt="" aria-hidden className="w-full h-auto" />
                </div>
            </div>
            ...
            <div className="max-w-[1200px] w-full px-8 flex flex-col items-center z-10 text-center pointer-events-auto">
                ...
                <h1 className="hero-anim font-display text-[clamp(48px,6vw,80px)] font-bold tracking-[-0.03em] leading-[1.05] mb-6">
                    Your AI spend, audited.<br />Before it compounds.
                </h1>

                <p className="hero-anim max-w-[650px] text-lg text-textMuted mb-10 text-balance leading-relaxed">
                    SpendLens runs a fast AI spend audit in the background of planning decisions. It flags overlap, plan mismatch, and benchmark drift so teams can cut waste before it compounds.
                </p>
                ...
                <div className="hero-anim w-full max-w-[800px] bg-dark rounded-card p-6 shadow-2xl border border-white/5 text-left font-mono text-sm leading-relaxed overflow-hidden relative">
                    ...
                    <div className="text-textInverse/60 flex flex-col gap-2">
                        <div><span className="text-primary mr-2">-&gt;</span><span className="text-tertiary">spendlens</span> audit --stack=startup-ai-stack</div>
                        <div>[SpendLens] Inputs captured: tools, seats, monthly spend.</div>
                        <div className="mt-4"><span className="text-purple">* Stack Score</span> calculating overlap and plan-fit.</div>
                        <div><span className="text-purple opacity-70 ml-4">-&gt; Duplicate seats detected across assistants.</span></div>
                        <div className="mt-2"><span className="text-tertiary">* Benchmark Engine</span> comparing against peer spend ranges...</div>
                        <div><span className="text-tertiary opacity-70 ml-4">-&gt; Cost-per-seat is 31% above cohort median.</span></div>
                        <div className="mt-2"><span className="text-primary">* Savings Planner</span> generating prioritized actions...</div>
                        <div><span className="text-primary opacity-70 ml-4">-&gt; Annual savings potential finalized.</span></div>
                        <div className="mt-4 flex items-center text-textInverse">
                            <span>Report ready. Open recommendations.</span><span className="cursor-blink inline-block w-2.5 h-4 bg-primary ml-2 mb-[-2px]"></span>
                        </div>
                    </div>
                </div>
            </div>
...
const logos = [
    {
        ...
        svg: (
            <div className="flex flex-row items-center gap-2 px-6 group cursor-default text-gray-400 hover:text-gray-900 transition-colors">
                ...
                <span className="text-[17px] font-bold whitespace-nowrap">ChatGPT Team</span>
            </div>
        )
    },
    {
        ...
        svg: (
            <div className="flex flex-row items-center gap-2 px-6 group cursor-default text-gray-400 hover:text-gray-900 transition-colors">
                ...
                <span className="text-[17px] font-bold whitespace-nowrap">Claude Team</span>
            </div>
        )
    },
    {
        ...
        svg: (
            <div className="flex flex-row items-center gap-2 px-6 group cursor-default text-gray-400 hover:text-gray-900 transition-colors">
                ...
                <span className="text-[17px] font-bold whitespace-nowrap">Copilot Pro</span>
            </div>
        )
    },
    {
        ...
        svg: (
            <div className="flex flex-row items-center gap-2 px-6 group cursor-default text-gray-400 hover:text-gray-900 transition-colors">
                ...
                <span className="text-[17px] font-bold whitespace-nowrap">Gemini</span>
            </div>
        )
    },
    {
        ...
        svg: (
            <div className="flex flex-row items-center gap-2 px-6 group cursor-default text-gray-400 hover:text-gray-900 transition-colors">
                ...
                <span className="text-[17px] font-bold whitespace-nowrap">Perplexity Pro</span>
            </div>
        )
    },
    {
        ...
        svg: (
            <div className="flex flex-row items-center gap-2 px-6 group cursor-default text-gray-400 hover:text-gray-900 transition-colors">
                ...
                <span className="text-[17px] font-bold whitespace-nowrap">Gemini Business</span>
            </div>
        )
    },
    {
        ...
        svg: (
            <div className="flex flex-row items-center gap-2 px-6 group cursor-default text-gray-400 hover:text-gray-900 transition-colors">
                ...
                <span className="text-[17px] font-bold whitespace-nowrap">Notion AI</span>
            </div>
        )
    },
    {
        ...
        svg: (
            <div className="flex flex-row items-center gap-2 px-6 group cursor-default text-gray-400 hover:text-gray-900 transition-colors">
                ...
                <span className="text-[17px] font-bold whitespace-nowrap">Midjourney</span>
            </div>
        )
    },
];
        ...
        <section className="w-full bg-white py-6 overflow-hidden">
            <div className="max-w-[1200px] mx-auto px-4 mb-4 text-center reveal">
                <p className="text-[17px] font-semibold text-[#151515]">
                    Finance and engineering teams use SpendLens to audit AI subscriptions, benchmark spend, and prioritize savings actions.
                </p>
            </div>
...
function TimelineSvg() {
    ...
    const bridgeBallRef = useRef<SVGCircleElement>(null);
    const columnRefs = useRef<(HTMLDivElement | null)[]>([]);
    const bridgePathD = "M -1 46.5981 L 238.848 185.075 C248.416 190.599 260.201 190.613 269.782 185.113L342.038 143.63C351.001 138.485 362.027 138.498 370.978 143.666L552.998 248.755C562.589 254.293 574.407 254.293 583.998 248.755L627.498 223.641C636.471 218.461 647.526 218.461 656.498 223.641L726.09 263.821C735.681 269.358 747.498 269.358 757.09 263.821L799.348 239.423C808.32 234.243 819.375 234.243 828.348 239.423L979.999 326.979C989.59 332.517 1001.41 332.517 1011 326.979L1250.83 188.514C1259.8 183.334 1270.86 183.334 1279.83 188.514L1322.5 213.15C1332.09 218.687 1343.91 218.687 1353.5 213.15L1441 162.632";

    useEffect(() => {
        if (!containerRef.current) return;
        const ctx = gsap.context(() => {
            if (bridgePathRef.current && bridgeBallRef.current && bridgeFrameRef.current) {
                gsap.set(bridgeBallRef.current, { opacity: 0, scale: 0.7, transformOrigin: '50% 50%' });
                const bridgeTl = gsap.timeline({
                    scrollTrigger: {
                        trigger: bridgeFrameRef.current,
                        start: 'top 80%',
                        end: 'bottom 35%',
                        scrub: 1
                    }
                ...
                bridgeTl
                    .to(bridgeBallRef.current, { opacity: 1, scale: 1, duration: 0.15, ease: 'power2.out' }, 0)
                    .to(bridgeBallRef.current, {
                        motionPath: {
                            path: bridgePathRef.current,
                            align: bridgePathRef.current,
                            alignOrigin: [0.5, 0.5]
                        },
                        duration: 1,
                        ease: 'none'
                    }, 0)
                    .to(bridgeBallRef.current, { fill: '#22d3ee', duration: 0.12 }, 0.35)
                    .to(bridgeBallRef.current, { fill: '#60a5fa', duration: 0.12 }, 0.62)
                    .to(bridgeBallRef.current, { fill: '#34d399', duration: 0.12 }, 0.86);
            }

            const columns = columnRefs.current.filter((el): el is HTMLDivElement => el !== null);
            if (columns.length) {
                gsap.fromTo(
                    columns,
                    { y: 36, opacity: 0 },
                    {
                        ...
                        stagger: 0.16,
                        scrollTrigger: {
                            trigger: bridgeFrameRef.current ?? containerRef.current,
                            start: 'top 70%'
                        }
                    }
                );
    ...
    return (
        <section className="features-section bg-[#151515] pb-[200px]" ref={containerRef}>
            <div className="timeline-bridge-wrapper w-full flex justify-center" style={{ position: 'relative' }}>
                <div ref={bridgeFrameRef} className="w-full relative">
                    <img src="/assets/landing-page/timeline-bridge.svg" alt="" aria-hidden className="w-full h-auto" />
                    <svg
                        aria-hidden
                    ...
                    >
                        <path ref={bridgePathRef} d={bridgePathD} fill="none" stroke="none" />
                        <circle
                            ref={bridgeBallRef}
                            cx="-1"
                            cy="46.5981"
            ...
            <div className="max-w-[1200px] w-full mx-auto px-8">
                <div className="split-feature-container" style={{ marginTop: '-4px' }}>
                    {/* Left Column: Finance + Ops */}
                    <div ref={(el) => { columnRefs.current[0] = el; }} className="w-[100%] md:w-1/2 mt-0">
                        <div className="feature-half developer-feature pl-4 md:pl-16 pr-8 pt-10 pb-20 bg-transparent flex flex-col items-start justify-start relative z-10 w-full h-full">
                            <h2 className="text-[1.75rem] leading-tight font-bold mb-4 tracking-tight max-w-[400px]">
                                <span className="text-purple-500 font-semibold mb-1 block text-sm tracking-wider uppercase"><TextGenerate delay={0}>Finance + Ops</TextGenerate></span>
                                <span className="text-white"><TextGenerate delay={0.1}>Stop hidden AI spend before it compounds</TextGenerate></span>
                            </h2>
                            <p className="text-gray-400 text-lg mb-8 max-w-[400px] leading-relaxed">
                                <TextGenerate delay={0.2}>SpendLens maps seat usage, plan mismatch, and benchmark deltas so budget decisions are fast and defensible.</TextGenerate>
                            </p>
                            <ul className="text-white space-y-6 mb-10 w-full max-w-[400px]">
                                <li className="flex items-start gap-4">
                                    ...
                                    <span className="font-medium text-lg leading-snug"><TextGenerate delay={0.3}>Detect duplicate seats across assistants instantly</TextGenerate></span>
                                </li>
                                <li className="flex items-start gap-4">
                                    ...
                                    <span className="font-medium text-lg leading-snug"><TextGenerate delay={0.4}>Surface plan mismatch before monthly renewals hit</TextGenerate></span>
                                </li>
                                <li className="flex items-start gap-4">
                    ...
                    {/* Right Column: Product + Leadership */}
                    <div ref={(el) => { columnRefs.current[1] = el; }} className="w-[100%] md:w-1/2 mt-8 md:mt-32">
                        <div className="feature-half marketer-feature pr-4 md:pr-16 pl-8 pt-10 pb-20 relative z-20 w-full flex flex-col items-start justify-start marketer-tail-card">
                            <h2 className="text-[1.75rem] leading-tight font-bold mb-4 tracking-tight max-w-[400px]">
                                <span className="text-blue-500 font-semibold mb-1 block text-sm tracking-wider uppercase"><TextGenerate delay={0}>Product + Leadership</TextGenerate></span>
                                <span className="text-[#151515]"><TextGenerate delay={0.1}>Prioritize savings actions with confidence</TextGenerate></span>
                            </h2>
                            <p className="text-gray-600 text-lg mb-8 max-w-[400px] leading-relaxed">
                                <TextGenerate delay={0.2}>From stack score to negotiation levers, SpendLens turns noisy tooling data into a clean report your team can act on today.</TextGenerate>
                            </p>
                            <ul className="text-[#151515] space-y-6 mb-10 w-full max-w-[400px]">
                                <li className="flex items-start gap-4">
                                    ...
                                    <span className="font-medium text-lg leading-snug"><TextGenerate delay={0.3}>Rank opportunities by savings impact and confidence</TextGenerate></span>
                                </li>
                                <li className="flex items-start gap-4">
                                    ...
                                    <span className="font-medium text-lg leading-snug"><TextGenerate delay={0.4}>Benchmark every tool against similar team profiles</TextGenerate></span>
                                </li>
                                <li className="flex items-start gap-4">
...
const problems = [
    ...
    { icon: AlertTriangle, title: "Plan Mismatch Burns Budget", desc: "High-tier plans stay active even when usage patterns no longer justify them." },
    { icon: UserX, title: "Negotiation Windows Get Missed", desc: "Without benchmarks, teams overpay and miss high-impact vendor leverage moments." }
];
            ...
            <div className="max-w-[1200px] w-full mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-[64px]">
                ...
                <div>
                    ...
                    <h2 className="font-display text-[clamp(32px,4.5vw,56px)] font-bold tracking-tight leading-[1.05] mb-12 flex flex-col gap-2">
                        <span>Teams buy tools.</span>
                        <span>Not clarity.</span>
                    </h2>
                    ...
                    <div className="sticky top-[120px] flex flex-col gap-8">
                        <div>
                            <div className="bg-surface rounded-card p-10 flex flex-col gap-4 transition-transform duration-300 hover:-translate-y-1">
                                <span className="text-textMuted font-medium text-lg">Avg time to locate overspend</span>
                                <div className="font-display font-bold text-6xl text-dark">4.7 Weeks</div>
                        ...
                        <div>
                            <div className="bg-surface rounded-card p-10 transition-transform duration-300 hover:-translate-y-1">
                                <span className="text-textMuted font-medium text-lg mb-6 block">Current AI Spend Breakdown</span>
                                <div className="flex flex-col gap-4 w-full">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="flex justify-between text-sm font-medium">
                                            ...
                                            <span className="text-textMuted cursor-default text-primary">38%</span>
                                        </div>
                                        <div className="h-4 w-full bg-borderSubtle rounded-pill overflow-hidden"><div className="h-full bg-primary w-[38%] rounded-pill"></div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
const agents = [
    ...
    { name: "Savings Planner", role: "Action Prioritization", color: "#3BBB96", icon: Map, desc: "Turns findings into concrete next steps with projected monthly and annual savings.", features: ["Recommendation Ranking", "What-if Scenarios", "Negotiation Levers"] }
];
            ...
            <div className="max-w-[1200px] w-full mx-auto px-8">
                <div className="text-center mb-16">
                    <h2 className="font-display text-[clamp(28px,4vw,48px)] font-bold tracking-tight leading-[1.05] flex flex-col gap-2">
                        <TextGenerate delay={0}>Three Engines.</TextGenerate>
                        <TextGenerate delay={0.2}>One Spend Verdict.</TextGenerate>
                    </h2>
                </div>
...
const capabilities = [
    ...
    { icon: Edit3, title: "Savings Scenarios", desc: "Models monthly and annual outcomes for every recommendation." },
    { icon: Book, title: "Method Transparency", desc: "Shows exactly why each finding was generated." },
    { icon: MapPin, title: "Executive Brief", desc: "Creates concise decision-ready summaries for leadership." },
    { icon: AlertCircle, title: "Risk Flags", desc: "Highlights overlap, plan drift, and vendor concentration risk." },
    { icon: TrendingUp, title: "Benchmark Context", desc: "Compares your stack against peer team spend patterns." },
    { icon: Settings, title: "Action Queue", desc: "Prioritizes what to do first based on impact and confidence." }
];
        ...
        <section ref={sectionCallbackRef} className="h-screen flex items-center text-white overflow-hidden py-20 relative bg-[#151515]">
            <div className="min-w-[400px] w-[400px] self-stretch z-20 flex flex-col justify-center bg-[#151515] relative">
                ...
                <div className="px-12 md:px-20 relative z-10">
                    ...
                    <h2 className="font-display text-[clamp(40px,5vw,64px)] font-bold tracking-tight leading-[1] text-white">
                        Built to Explain,<br />Then Optimize.
                    </h2>
                    <p className="mt-8 text-lg text-textInverse/60 max-w-sm">
                        A granular look into the systems powering SpendLens. Scroll to inspect each decision layer.
                    </p>
                </div>
            </div>
            <div ref={scrollContainerRef} className="flex gap-6 pl-20 pr-[20vw] relative items-center">
                {capabilities.map((cap, i) => (
                    <CardGenerate key={i} delay={i * 0.1} duration={0.7} triggerEl={sectionEl} className="w-[350px] h-[350px] flex-shrink-0 bg-[#222] border border-white/10 rounded-card p-10 hover:bg-[#2A2A2A] transition-colors">
                        ...
                        <div>
                            <h3 className="font-display text-2xl font-bold mb-3 text-white"><TextGenerate delay={i * 0.1}>{cap.title}</TextGenerate></h3>
...
function HowItWorks() {
    ...
    const steps = [
        { Icon: Zap, num: '01', title: 'Start Audit', desc: 'Enter team size, primary workflows, and tools in under a minute.' },
        { Icon: Activity, num: '02', title: 'Stack Analysis', desc: 'SpendLens evaluates overlap, plan-fit, benchmarks, and seat efficiency.' },
        { Icon: Cpu, num: '03', title: 'Score & Insights', desc: 'Stack Score, confidence, and impact-ranked recommendations are generated.' },
        { Icon: ShieldCheck, num: '04', title: 'Validate Scenarios', desc: 'Use what-if modeling to compare savings outcomes before rollout.' },
        { Icon: Settings, num: '05', title: 'Share & Execute', desc: 'Export your report, align stakeholders, and run actions by priority.' },
    ];
        ...
        <section ref={sectionRef} className="relative bg-[#f5f4f0] py-24 overflow-hidden">
            ...
            <div className="text-center mb-10 relative z-20 px-8">
                ...
                <h2 className="font-display text-[clamp(40px,5vw,64px)] font-bold tracking-tight leading-[1] text-[#151515]">
                    Input Once.<br />Act with Confidence.
                </h2>
                <p className="mt-4 text-textMuted text-lg max-w-[480px] mx-auto">
                    Five clear stages that convert tool data into a defensible savings plan.
                </p>
            </div>
...
function TechStack() {
    const chips = [
        ...
        "Negotiation Leverage", "Cost Per Developer", "Savings Priority Queue",
        "Stack Grade Output", "Shareable Report", "What-if Simulator",
        "ChatGPT ? Claude ? Copilot ? APIs"
    ];
    return (
        <section className="py-[120px] bg-background">
            <div className="max-w-[1200px] w-full mx-auto px-8 flex flex-col items-center text-center">
                ...
                <p className="text-lg text-textMuted max-w-[600px] mb-16 leading-relaxed">
                    <TextGenerate delay={0.6}>SpendLens combines deterministic pricing rules, benchmark intelligence, and AI summarization so teams can cut waste without slowing product velocity.</TextGenerate>
                </p>
            ...
            <div className="max-w-[1200px] w-full mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-[80px]">
                <div>
                    ...
                    <h2 className="font-display text-[clamp(40px,5vw,64px)] font-bold tracking-tight leading-[1] flex flex-col gap-1">
                        ...
                        <span>Without Spreadsheet Chaos.</span>
                    </h2>
                    <p className="mt-8 text-lg text-textMuted max-w-sm mb-16 leading-relaxed">
                        Stop waiting for end-of-quarter surprises. SpendLens keeps your AI spend decisions clear, measurable, and fast.
                    </p>
                    <div className="grid grid-cols-2 gap-x-8 gap-y-16">
                        ...
                        <div><h3 ref={el => { numsRef.current[1] = el }} data-target="3" data-suffix="x" className="font-display text-5xl font-bold text-primary mb-2">0x</h3><p className="font-medium text-textMain">Faster budget decisions</p></div>
                        <div><h3 ref={el => { numsRef.current[2] = el }} data-target="94" data-suffix="%" className="font-display text-5xl font-bold text-primary mb-2">0%</h3><p className="font-medium text-textMain">Overspend risks flagged early</p></div>
                        <div><h3 ref={el => { numsRef.current[3] = el }} data-target="2" data-suffix="h" className="font-display text-5xl font-bold text-primary mb-2">0</h3><p className="font-medium text-textMain">Median audit completion time</p></div>
                    </div>
                </div>
                <div className="flex flex-col justify-center gap-6">
                    {[
                        { icon: Activity, title: "Protect Product Focus", desc: "Teams stop burning sprint time on vendor pricing detective work." },
                        { icon: Zap, title: "Accelerate Spend Optimization", desc: "Actionable recommendations for every tool in your stack." },
                        { icon: ShieldCheck, title: "Defensible Decisions", desc: "Every recommendation includes rationale and confidence context." },
                        { icon: Clock, title: "Move Faster on Budget", desc: "Get benchmarked savings actions your team can apply this week." }
                    ].map((item, i) => (
...
function CTA() {
        ...
        <footer className="bg-dark text-textInverse pt-[160px] pb-[80px] relative overflow-hidden">
            ...
            <div className="max-w-[1200px] w-full mx-auto px-8 pb-[100px] border-b border-borderInv flex flex-col items-center text-center relative z-10">
                ...
                <h2 className="font-display text-[clamp(48px,6vw,80px)] font-bold tracking-tight leading-[1] mb-8 text-white">
                    <TextGenerate delay={0.2}>Your AI Spend Intelligence Layer.</TextGenerate><br />
                    <TextGenerate delay={0.4}>Ready in Minutes.</TextGenerate>
                </h2>
                <p className="text-xl text-textInverse/60 max-w-[500px] mb-12">
                    <TextGenerate delay={0.6}>Free tier available. No credit card required. Start your first audit in under 2 minutes.</TextGenerate>
                </p>
            ...
            <div className="max-w-[1200px] w-full mx-auto px-8 pt-[80px] grid grid-cols-1 md:grid-cols-4 gap-12 text-sm">
                <div className="md:col-span-1">
                    <div className="font-display font-bold text-2xl tracking-tight mb-4">SpendLens.</div>
                    <p className="text-textInverse/40 max-w-[250px]">The AI spend intelligence layer for founders, finance, and engineering leaders.</p>
                </div>
        ...
        <div className="bg-background min-h-screen font-body flex flex-col text-textMain relative" style={{ backgroundColor: 'var(--color-background)' }}>
            ...
            <header className={`sticky top-0 z-50 border-b transition-all duration-300 ${isScrolled ? 'bg-white/70 backdrop-blur-md border-borderSubtle' : 'bg-transparent border-transparent'}`}>
                <div className="w-full px-8 h-20 flex items-center justify-between">
                    <div className="font-display font-bold text-xl tracking-tight">SpendLens.</div>
                    <button onClick={() => { window.location.href = '/audit'; }} className="bg-dark text-textInverse px-5 py-2.5 rounded-button font-medium hover:bg-dark/90 transition-colors">
                        Run Audit
                    </button>
                </div>
            </header>
